            ...
            <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link active nav-column-border" href="{{url('make-up')}}">Make-Up</a></li>
    ...
    <div class="container">
        ...
        @foreach($makeups as $makeup)
            <div class="responsive">
                <div class="gallery">
                    <a target="_blank" href="{{url('product')}}/{{$makeup->sku}}">
                        <img src="{{$makeup->image}}" alt="{{$makeup->name}}" style="max-width:250px;max-height:250px;">
                    </a>
                    <div class="desc">{{$makeup->name}}</div>
                </div>
            </div>
        @endforeach
